...
<body>
    ...
    <?php include './change_appointment.php'; ?>
    ...
    <div class='container mt-3 mb-5'>
        ...
        <div class='container'>
            ...
            <!-- Form -->
            <form method='POST' action='change_appointment_page.php?appointment_id=<?php echo urlencode($_GET['appointment_id']);?>&doctor_id=<?php echo urlencode($doctor_id); ?>'>
                <!-- Date and Time -->
                <div class="row mb-3">
                    <!-- Appointment Date -->
                    <div class="col-sm g3 mb-3">
                        <div class='input-group'>
                            ...
                            <input type="date" name='appointment-date' id='appointment-date' class="form-control" aria-label="Appointment date" value=<?php echo $appointmentDetails['appointment_date']; ?> require>
                        </div>
                    ...
                    <div class="col-sm g3 mb-3">
                        <div class='input-group'>
                            ...
                            <input type="time" id='appointment-time' name='appointment-time' class="form-control" aria-label="Appointment time" value=<?php echo $appointmentDetails['appointment_time']; ?> required>
                        </div>
                ...
                <div class='row mb-4'>
                    <div class="form-floating p-1">
                        <textarea class="form-control" name='remarks' placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"><?php echo $appointmentDetails['remarks'] ?></textarea>
        ...
        <div class='cotainer text-center'>
            <button type="submit" class="btn btn-warning me-5">Submit</button>
            <button type="button" class="btn btn-light"><i class="bi bi-x"></i> Cancel</button>
        </div>
        </form>
    </div>
    ...
    <script>
        ...
        const appointmentDetails = <?php echo json_encode($appointmentDetails); ?>;
