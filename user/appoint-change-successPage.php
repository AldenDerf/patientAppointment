...
<body>
    ...
    <?php include './appoint-change-success.php'; ?>
        ...
        <div class='col-sm-6  m-auto'>
            <div class="card pb-3">
                <div class='row-4 text-center'>
                    ...
                    <h4 class="card-title text-success text-center mt-0 ">Successfuly changed!</h4>
                </div>
                <div class="card-body p-3">

                    <p style='text-align: justify'>Dear <span id='patient-name' style='font-weight:bold;'>[Patient Name]</span>,</p>
                    <p class="card-text">Your appointment with <b><span id='doctor_name'>[Doctor's Name]</span></b> has been <span class='text-success' style='font-weight:bold;'>successfully booked</span>. We look forward to seeing you on <span style="font-weight: bold;" id='appointment-date'>[Date]</span> at <span id='appointment-time' style='font-weight:bold'>[Time]</span>. If you have any questions, feel free to <a href='#'>contact us</a>.</p>
                    <p>Thank you!</p>
